                ...
                <div class="navbar-wrapper">
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        @if( Gate::check('manage bill')  ||  Gate::check('manage payment') ||  Gate::check('manage debit note'))
                                            <li class="dash-item dash-hasmenu {{(Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'active dash-trigger' :''}}">
                                                <a class="dash-link" href="#">{{__('Expense')}}<span class="dash-arrow"><i
                                                            data-feather="chevron-right"></i></span></a>
                                                <ul class="dash-submenu">
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        @can('manage project task')
                                            <li class="dash-item {{ (request()->is('calendar*') ? 'active' : '')}}">
                                                <a class="dash-link"
                                                   href="{{ route('task.calendar',['all']) }}">{{__('Task Calender')}}</a>
                                            </li>
                                        @endcan
                    ...
                    <!--------------------- End Products System ----------------------------------->
                        ...
                        @if(\Auth::user()->type!='super admin')
                            ...
                            {{--                                <span class="dash-micon"><i class="ti ti-headphones"></i></span><span class="dash-mtext">{{__('Maintenance')}}</span>--}}
                            {{--                            </a>--}}
                            {{--                        </li>--}}
                            <li class="dash-item dash-hasmenu">
                                <a href="#!" class="dash-link ">
                                    <span class="dash-micon"><i class="ti ti-headphones"></i></span><span
                                        class="dash-mtext">{{__('Maintenance')}}</span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                                </a>
                                <ul class="dash-submenu">

                                    <li class="dash-item dash-hasmenu {{ (Request::route()->getName() == 'support.index') ? ' active' : '' }}">
                                        <a href="{{route('support.index')}}" class="dash-link">{{__('Maintenance Orders')}}</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
