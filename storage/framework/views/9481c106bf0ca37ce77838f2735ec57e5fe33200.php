...
<?php if(isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on' || $setting['SITE_RTL'] =='on'): ?>
                ...
                <div class="navbar-wrapper">
                    <div class="m-header main-logo">
                        <a href="#" class="b-brand">
                            <img src="<?php echo e(asset(Storage::url('uploads/logo/'.$logo))); ?>" alt="<?php echo e(env('APP_NAME')); ?>"
                                 class="logo logo-lg"/>
                        </a>
                    </div>
                    ...
                    <!--------------------- End Dashboard ----------------------------------->
                        ...
                        || Request::segment(1) == 'leavetype' || Request::segment(1) == 'leave' ||
                                Request::segment(1) == 'attendanceemployee' || Request::segment(1) == 'document-upload' || Request::segment(1) == 'document' || Request::segment(1) == 'performanceType'  ||
                                    ...
                                    <a href="#!" class="dash-link "><span class="dash-micon"><i class="ti ti-user"></i></span><span
                                    ...
                                    <ul class="dash-submenu">
                                        <li class="dash-item  <?php echo e((Request::segment(1) == 'employee' ? 'active dash-trigger' : '')); ?>   ">
                                            <?php if(\Auth::user()->type =='Employee'): ?>
                                                ...
                                                ?>
                                                <a class="dash-link"
                                                   href="<?php echo e(route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt(\Auth::user()->id))); ?>"><?php echo e(__('Employee')); ?></a>
                                            <?php else: ?>
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show career')): ?>
                                                    <li class="dash-item <?php echo e((request()->is('career*') ? 'active' : '')); ?>">
                                                        <a class="dash-link"
                                                           href="<?php echo e(route('career',[\Auth::user()->creatorId(),'en'])); ?>"><?php echo e(__('Career')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </li>
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        <?php if( Gate::check('manage bill')  ||  Gate::check('manage payment') ||  Gate::check('manage debit note')): ?>
                                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note')? 'active dash-trigger' :''); ?>">
                                                <a class="dash-link" href="#"><?php echo e(__('Expense')); ?><span class="dash-arrow"><i
                                                            data-feather="chevron-right"></i></span></a>
                                                <ul class="dash-submenu">
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task')): ?>
                                            <li class="dash-item <?php echo e((request()->is('calendar*') ? 'active' : '')); ?>">
                                                <a class="dash-link"
                                                   href="<?php echo e(route('task.calendar',['all'])); ?>"><?php echo e(__('Task Calender')); ?></a>
                                            </li>
                                        <?php endif; ?>
                            ...
                            <li class="dash-item dash-hasmenu">
                                <a href="#!" class="dash-link ">
                                    <span class="dash-micon"><i class="ti ti-headphones"></i></span><span
                                        class="dash-mtext"><?php echo e(__('Maintenance')); ?></span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                                </a>
                                <ul class="dash-submenu">

                                    <li class="dash-item dash-hasmenu <?php echo e((Request::route()->getName() == 'support.index') ? ' active' : ''); ?>">
                                        <a href="<?php echo e(route('support.index')); ?>" class="dash-link"><?php echo e(__('Maintenance Orders')); ?></a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">استقبال طلبات الصيانة</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">دراسة وتخطيط طلبات الصيانة</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">إعتماد ميزانية طلبات الصيانة</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">تشييك الكميات في المخازن</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">جدولة أوامر الصيانة</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">تنفيذ أوامر الصيانة</a>
                                    </li>
                                    <li class="dash-item dash-hasmenu ">
                                        <a href="#" class="dash-link">إغلاق أوامر الصيانة</a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <?php if(Gate::check('manage system settings')): ?>
                                    <li class="dash-item dash-hasmenu <?php echo e((Request::route()->getName() == 'systems.index') ? ' active' : ''); ?>">
                                        <a href="<?php echo e(route('systems.index')); ?>" class="dash-link">
                                            <span class="dash-micon"><i class="ti ti-settings"></i></span><span
                                                class="dash-mtext"><?php echo e(__('System Setting')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
