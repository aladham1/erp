                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3"><h3><?php echo e($user->total_user); ?></h3></div>
                            <div class="ms-3 mb-3 mt-3">
                                <h6><?php echo e(__('PAID USERS')); ?> : <span class="text-dark text-sm"><?php echo e($user['total_paid_user']); ?></span></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3"><h3><?php echo e($user->total_orders); ?></h3></div>
                            <div class="ms-3 mb-3 mt-3">
                                <h6><?php echo e(__('Total Order Amount')); ?> : <span class="text-dark text-sm"><?php echo e(\Auth::user()->priceFormat($user['total_orders_price'])); ?></span></h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="number-icon ms-3 mb-3 mt-3"><h3><?php echo e($user->total_plan); ?></h3></div>
                            <div class="ms-3 mb-3 mt-3">
                                <h6><?php echo e(__('Most Purchase Plan')); ?> : <span class="text-dark text-sm"><?php echo e($user['most_purchese_plan']); ?></span></h6>
                        </div>
                    </div>
                </div>
            </div>
